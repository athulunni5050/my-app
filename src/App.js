...
class App extends React.Component {
  ...
  componentDidMount() {
    axios.get("https://mongoo.azurewebsites.net/api/").then((res) => {
      this.setState({
        tasks: res.data,
        id: 0,
        task: "",
  ...
  submit(event, id) {
    ...
    axios
      .post("https://mongoo.azurewebsites.net/api/", {
  ...
  delete(id) {
    axios.delete("https://mongoo.azurewebsites.net/api/" + id).then(() => {
  ...
  edit(id) {
    console.log(id)
    axios.put("https://mongoo.azurewebsites.net/api/" + id).then(() => {
      this.setState({
